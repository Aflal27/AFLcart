...
export default function UpdateOrder() {
   ...
   const {orderItems=[],shippingInfo={},totalPrice=0,paymentInfo={}} = orderDetail
    ...
    const submitHandler = (e) => {
        e.preventDefault();
        const orderData = {};
        orderData.orderState = orderStatus
    ...
    useEffect(() => {
        if(isOrderUpdated) {
            toast('Order Update Succesfully!',{
                type: 'success',
                ...
                <div className="row d-flex justify-content-around">
                    ...
                    <div className="col-12 col-lg-3 mt-5">
                        ...
                        <button className="btn btn-primary btn-block"
                            disabled={loading}
                            onClick={submitHandler}>Update Status</button>
                    </div>
